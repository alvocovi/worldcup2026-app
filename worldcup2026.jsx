...
const TZ_TO_COUNTRY = {
  ...
  "America/Toronto":"CA","America/Vancouver":"CA","America/Winnipeg":"CA","America/Halifax":"CA","America/St_Johns":"CA",
  "America/Mexico_City":"MX","America/Monterrey":"MX","America/Tijuana":"MX","America/Merida":"MX",
  "America/Sao_Paulo":"BR","America/Fortaleza":"BR","America/Manaus":"BR","America/Belem":"BR","America/Recife":"BR",
  "America/Argentina/Buenos_Aires":"AR","America/Argentina/Cordoba":"AR","America/Argentina/Mendoza":"AR",
  "America/Bogota":"CO","America/Santiago":"CL","America/Lima":"PE","America/Montevideo":"UY",
  "America/Guayaquil":"EC","America/Asuncion":"PY","America/Caracas":"VE",
  "Europe/London":"GB","Europe/Berlin":"DE","Europe/Paris":"FR","Europe/Madrid":"ES","Europe/Rome":"IT",
  "Europe/Lisbon":"PT","Europe/Amsterdam":"NL","Europe/Brussels":"BE","Europe/Vienna":"AT",
  "Europe/Zurich":"CH","Europe/Stockholm":"SE","Europe/Oslo":"NO","Europe/Copenhagen":"DK",
  "Europe/Helsinki":"FI","Europe/Warsaw":"PL","Europe/Dublin":"IE","Europe/Zagreb":"HR",
  "Europe/Belgrade":"RS","Europe/Athens":"GR","Europe/Istanbul":"TR","Europe/Kiev":"UA","Europe/Kyiv":"UA",
  "Europe/Prague":"CZ","Europe/Budapest":"HU","Europe/Sofia":"BG","Europe/Bratislava":"SK",
  "Europe/Ljubljana":"SI","Europe/Moscow":"RU","Atlantic/Reykjavik":"IS","Europe/Tirane":"AL",
  "Europe/Sarajevo":"BA","Europe/Skopje":"MK","Europe/Tbilisi":"GE","Asia/Yerevan":"AM","Asia/Baku":"AZ",
  "Asia/Tokyo":"JP","Asia/Seoul":"KR","Asia/Shanghai":"CN","Asia/Urumqi":"CN","Asia/Chongqing":"CN",
  "Australia/Sydney":"AU","Australia/Melbourne":"AU","Australia/Brisbane":"AU","Australia/Perth":"AU","Australia/Adelaide":"AU",
  "Pacific/Auckland":"NZ","Asia/Kolkata":"IN","Asia/Calcutta":"IN","Asia/Singapore":"SG",
  "Asia/Kuala_Lumpur":"MY","Asia/Jakarta":"ID","Asia/Makassar":"ID","Asia/Bangkok":"TH",
  "Asia/Ho_Chi_Minh":"VN","Asia/Saigon":"VN","Asia/Manila":"PH","Asia/Hong_Kong":"HK","Asia/Taipei":"TW",
  "Asia/Kabul":"AF","Asia/Ulaanbaatar":"MN","Asia/Riyadh":"SA","Asia/Dubai":"AE",
  "Asia/Qatar":"QA","Africa/Cairo":"EG","Africa/Casablanca":"MA","Africa/Tunis":"TN",
  "Africa/Algiers":"DZ","Asia/Tehran":"IR","Asia/Baghdad":"IQ","Asia/Jerusalem":"IL","Asia/Amman":"JO",
  "Africa/Johannesburg":"ZA","Africa/Lagos":"NG","Africa/Accra":"GH","Africa/Nairobi":"KE",
  "Africa/Addis_Ababa":"ET","Africa/Dakar":"SN","Africa/Abidjan":"CI","Africa/Douala":"CM",
  "Africa/Kinshasa":"CD","Africa/Dar_es_Salaam":"TZ",
  "America/Costa_Rica":"CR","America/El_Salvador":"SV","America/Guatemala":"GT",
  "America/Tegucigalpa":"HN","America/Managua":"NI","America/Panama":"PA",
  "Asia/Almaty":"KZ","Asia/Tashkent":"UZ","Asia/Bishkek":"KG","Asia/Dushanbe":"TJ","Asia/Ashgabat":"TM",
};
...
function detectCountry() {
  try {
    ...
    if (parts.length >= 2) {
      ...
      if (BROADCAST_DATA[code]) return code;
    }
    const tz = Intl.DateTimeFormat().resolvedOptions().timeZone || "";
    if (TZ_TO_COUNTRY[tz] && BROADCAST_DATA[TZ_TO_COUNTRY[tz]]) return TZ_TO_COUNTRY[tz];
  } catch (_) {}
  return null;
}
...
export default function WorldCup2026() {
  ...
  // Auto-detect country from browser locale / timezone on first load
  useEffect(() => {
    const code = detectCountry();
    if (code) {
      setSelectedCountry(code);
      setSelectedRegion(BROADCAST_DATA[code].region);
            ...
            <div style={{ background: "#111827", borderRadius: 10, padding: "12px 14px", marginBottom: 10, border: "1px solid #1f2937" }}>
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                ...
                <CountrySearch
                  ...
                  onChange={code => { setSelectedCountry(code); setAutoDetected(false); }}
                />
              </div>
            </div>
